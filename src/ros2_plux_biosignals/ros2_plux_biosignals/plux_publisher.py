...
from python_utils.ros2_utils.node_manager import get_node
...
class MyPluxDevice(plux.SignalsDev):
    def __init__(self, address: str):
        ...
        self.plux_publisher = get_node(PLUX_ROS_NODE).create_publisher(PluxMsg, PLUX_ROS_TOPIC_NAME, 30)
    ...
    def onRawFrame(self, nSeq, data):
        plux_msg = PluxMsg()
        plux_msg.timestamp = rclpy.clock.Clock.now()
