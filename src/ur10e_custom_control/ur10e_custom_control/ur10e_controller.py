"""
UR controller. Example adopted from https://github.com/UniversalRobots/Universal_Robots_ROS2_Driver/blob/main/ur_robot_driver/scripts/example_move.py
"""
#!/usr/bin/env python3
...
class URController(Node):
    ...
    def __init__(self, initial_control_mode: URControlModes = URControlModes.SCALED_JOINT_TRAJECTORY):
        super().__init__("ur_custom_controller")
        self.declare_parameter("controller_name", initial_control_mode)
